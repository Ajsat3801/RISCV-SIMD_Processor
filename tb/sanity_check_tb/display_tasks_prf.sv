    ...
    task automatic display_prf_inout_vc();
        $display("[PRF INOUT] IN:[%0d (%b %b)] OUT:[%0d %0d %0d %0d (%h %h)]",
            dut.u_core.u_vector_prf.vc_lsu_rd_req_i.store_data_tag,
            dut.u_core.u_vector_prf.vc_lsu_rd_req_i.a_is_vector,
            dut.u_core.u_vector_prf.vc_lsu_rd_req_i.b_is_vector,
            $signed(dut.u_core.u_vector_prf.vc_lsu_ex_req_o.store_data[0]),
            $signed(dut.u_core.u_vector_prf.vc_lsu_ex_req_o.store_data[1]),
            $signed(dut.u_core.u_vector_prf.vc_lsu_ex_req_o.store_data[2]),
            $signed(dut.u_core.u_vector_prf.vc_lsu_ex_req_o.store_data[3]),
            dut.u_core.u_vector_prf.vc_lsu_ex_req_o.a_is_vector,
            dut.u_core.u_vector_prf.vc_lsu_ex_req_o.b_is_vector
        );
    endtask
